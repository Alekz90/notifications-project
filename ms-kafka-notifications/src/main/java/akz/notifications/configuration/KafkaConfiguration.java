package akz.notifications.configuration;
...
/**
 * KafkaConfiguration is a configuration class that defines Kafka topics for the application.
 */
@Configuration
