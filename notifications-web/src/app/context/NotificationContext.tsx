...
export const UseNotificationContext = createContext({} as NotificationContextProps);
...
export const NotificationContextProvider = ({ children }: PropsWithChildren) => {
  ...
  return (
    <UseNotificationContext value={{ notification, setNotification, notifications, setNotifications }}>
      {children}
