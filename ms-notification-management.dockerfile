...
COPY --from=build /app/ms-notification-management/build/libs/*.jar app.jar
...
#  -t "ms-notification-management-img:1.0.0" -f ms-notification-management.dockerfile .

# Ejecutar el contenedor
# docker run --name "ms-notification-management-container" "ms-notification-management-img:1.0.0"

# Delete the container
# docker container rm -f "ms-notification-management-container"

# Delete the image
# docker image rm "ms-notification-management-img:1.0.0"